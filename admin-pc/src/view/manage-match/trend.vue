<template>
	<div>
		...
		<!--添加Modal-->
		<Modal v-model="isAdd" :mask-closable="false" :closable="false" title="添加赛事动态：" width="900">
		...
		<!--编辑Modal-->
		<Modal v-model="isEdit" :mask-closable="false" :closable="false" title="编辑赛事动态：" width="900">
...
<script>
	import {getList,addList,delList,editList,getMatchList} from '@/api/match/trend'
